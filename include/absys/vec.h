...
ABSYS_API void absys_##NAME##_vec_init(struct absys_##NAME##_vec* vec);\
ABSYS_API void absys_##NAME##_vec_exit(struct absys_##NAME##_vec* vec);\
...
ABSYS_API void absys_##NAME##_vec_it_init(struct absys_##NAME##_vec_it* iter, struct absys_##NAME##_vec* vec);\
ABSYS_API void absys_##NAME##_vec_it_exit(struct absys_##NAME##_vec_it* iter);\
